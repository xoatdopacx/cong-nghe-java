...
/**
 * Controller cho module Sinh Viên.
 * URL: /admin/sinh-vien (chỉ ADMIN truy cập)
 */
@WebServlet(name = "SinhVienController", urlPatterns = "/admin/sinh-vien")
public class SinhVienController extends HttpServlet {
    ...
    private void listSinhVien(HttpServletRequest req, HttpServletResponse resp)
        ...
        req.getRequestDispatcher("/WEB-INF/views/admin/sinhvien/list.jsp").forward(req, resp);
    }
    ...
    private void showForm(HttpServletRequest req, HttpServletResponse resp, SinhVien sv)
        ...
        req.getRequestDispatcher("/WEB-INF/views/admin/sinhvien/form.jsp").forward(req, resp);
    }
