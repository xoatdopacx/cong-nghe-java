 ...
 */
@WebServlet(name = "MonHocController", urlPatterns = "/mon-hoc")
public class MonHocController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        switch (action) {
            case "create":
                ...
                req.getRequestDispatcher("/WEB-INF/views/monhoc/form.jsp").forward(req, resp);
                break;
            case "edit":
                ...
                mhRepo.findById(id).ifPresentOrElse(
                    mh -> {
                        ...
                        try { req.getRequestDispatcher("/WEB-INF/views/monhoc/form.jsp").forward(req, resp); }
                        catch (Exception e) { throw new RuntimeException(e); }
                    },
                    () -> {
                        try { resp.sendRedirect(req.getContextPath() + "/mon-hoc"); }
                        catch (Exception e) { throw new RuntimeException(e); }
                    }
                );
                break;
    ...
    private void listMonHoc(HttpServletRequest req, HttpServletResponse resp)
        ...
        req.getRequestDispatcher("/WEB-INF/views/monhoc/list.jsp").forward(req, resp);
    }
}
