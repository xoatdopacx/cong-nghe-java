...
import vn.edu.eaut.lab9.entity.*;

/**
 * Bài 12: DataSeeder - tạo dữ liệu mẫu khi database rỗng.
 */
public class DataSeeder {
    ...
    public static void seed() {
        ...
        try {
            ...
            long count = em.createQuery("SELECT COUNT(l) FROM LopHoc l", Long.class).getSingleResult();
            if (count > 0) {
            ...
            // === Người Dùng ===
            NguoiDung admin = new NguoiDung("admin", "admin123", "Quản trị viên", "admin@eaut.edu.vn", "ADMIN");
            NguoiDung user = new NguoiDung("hung", "123456", "Nguyễn Văn Hùng", "hung@eaut.edu.vn", "USER");
            em.persist(admin);
            em.persist(user);
