 ...
 */
@WebServlet(name = "LopHocController", urlPatterns = "/lop-hoc")
public class LopHocController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        switch (action) {
            case "create":
                ...
                req.getRequestDispatcher("/WEB-INF/views/lophoc/form.jsp").forward(req, resp);
                break;
            case "edit":
                ...
                lopRepo.findById(id).ifPresentOrElse(
                    lop -> {
                        ...
                        try { req.getRequestDispatcher("/WEB-INF/views/lophoc/form.jsp").forward(req, resp); }
                        catch (Exception e) { throw new RuntimeException(e); }
                    },
                    () -> {
                        try { resp.sendRedirect(req.getContextPath() + "/lop-hoc"); }
                        catch (Exception e) { throw new RuntimeException(e); }
                    }
                );
                break;
    ...
    private void listLopHoc(HttpServletRequest req, HttpServletResponse resp)
        ...
        req.getRequestDispatcher("/WEB-INF/views/lophoc/list.jsp").forward(req, resp);
    }
}
