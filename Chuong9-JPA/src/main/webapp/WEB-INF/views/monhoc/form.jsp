...
<div class="page-header">
    ...
    <a href="${pageContext.request.contextPath}/mon-hoc" class="btn btn-secondary">← Quay lại</a>
</div>
    ...
    <form method="post" action="${pageContext.request.contextPath}/mon-hoc">
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="text" id="maMon" name="maMon" class="form-control"
                       value="${monHoc.maMon}" required placeholder="VD: IT3242">
            </div>
            <div class="form-group">
                <label for="tenMon">Tên Môn *</label>
                <input type="text" id="tenMon" name="tenMon" class="form-control"
                       value="${monHoc.tenMon}" required placeholder="VD: Công nghệ Java">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="number" id="soTinChi" name="soTinChi" class="form-control"
                   value="${monHoc.soTinChi}" min="1" max="10" placeholder="VD: 3">
        </div>

        <div style="margin-top: 1rem;">
            <button type="submit" class="btn btn-success">${isEdit ? '💾 Cập Nhật' : '➕ Thêm Mới'}</button>
            <a href="${pageContext.request.contextPath}/mon-hoc" class="btn btn-secondary">Hủy</a>
        </div>
    </form>
</div>
